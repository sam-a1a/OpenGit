...
import {
    GitBranch, Shield, Play, Globe,
    GitPullRequest, CircleDot, Star
} from "lucide-react";
        ...
        <div className="min-h-screen bg-white dark:bg-gray-950">
            ...
            <nav className="border-b border-gray-100 dark:border-gray-900 px-6 py-4 flex items-center justify-between max-w-7xl mx-auto">
                ...
                <div className="flex items-center gap-3">
                    ...
                    {user ? (
                        <Link to="/explore"><Button size="sm">Dashboard</Button></Link>
                    ) : (
                        <>
            ...
            <div className="max-w-5xl mx-auto px-6 pt-20 pb-16 text-center">
                ...
                <p className="text-xl text-gray-500 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
                    ...
                    Everything you need — issues, PRs, CI/CD — on your own infrastructure.
                </p>
                <div className="flex items-center justify-center gap-4 flex-wrap">
                    ...
                    <Link to="/explore">
                        <Button variant="outline" size="lg">Explore repos</Button>
                    </Link>
                </div>
            ...
            <div className="max-w-6xl mx-auto px-6 py-16">
                ...
                <p className="text-center text-gray-500 mb-12">No feature behind a paywall. No vendor lock-in.</p>
            ...
            <div className="max-w-4xl mx-auto px-6 py-20 text-center">
                <div className="bg-blue-600 rounded-3xl p-12 text-white">
                    ...
                    <p className="text-blue-100 mb-8 text-lg">One command. Your data. Full control.</p>
                    <div className="flex items-center justify-center gap-4 flex-wrap">
                        <Link to="/register">
            ...
            {/* footer */}
            <div className="border-t border-gray-100 dark:border-gray-900 px-6 py-8">
